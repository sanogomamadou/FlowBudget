...
<head>
    ...
    <title>Sign Up - FlowBudget</title>
    ...
    <div class="max-w-md w-full bg-dark-lighter/50 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/10">
        <div class="p-6">
            ...
            <form method="POST" action="" class="space-y-4">
                <div>
                    <label for="nom" class="block text-sm font-bold text-gray-400 uppercase tracking-wider mb-1">Full Name</label>
                ...
                <div>
                    <label for="confirm_password" class="block text-sm font-bold text-gray-400 uppercase tracking-wider mb-1">Confirm Password</label>
                ...
                <button type="submit" 
                    class="w-full bg-primary hover:bg-primary/90 text-white font-bold py-3 rounded-xl transition-all shadow-[0_0_20px_rgba(0,168,204,0.4)] hover:scale-[1.02] active:scale-95 mt-2">
                    Sign Up
                </button>
            </form>
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-400">
                    ...
                    <a href="sign-in.php" class="text-primary hover:text-white font-bold transition-colors">Sign in</a>
                </p>
            </div>
        </div>
