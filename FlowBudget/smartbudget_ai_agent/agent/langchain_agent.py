...
from agent.tools import analyze_expenses,setBudget, estimerEconomies,ajouterTransaction,conseillerBudget,analyseFinanciereMensuelle, get_balance_prediction, get_smart_actions
import os
...
tools = [analyze_expenses,setBudget,estimerEconomies,ajouterTransaction,conseillerBudget,analyseFinanciereMensuelle, get_balance_prediction, get_smart_actions]
